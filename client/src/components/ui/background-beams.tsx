...
export const BackgroundBeamsWithCollision = ({
  ...
  return (
    <div
      ref={parentRef}
      className={cn(
        "fixed inset-0 bg-white dark:bg-black w-full h-full overflow-hidden pointer-events-none",
        className
      )}
    >
      {beams.map((beam) => (
  ...
  return (
    <>
      <motion.div
        ...
        className={cn(
          "absolute left-0 top-20 m-auto h-14 w-px rounded-full bg-gradient-to-t from-gray-900 via-gray-600 to-transparent dark:from-white dark:via-gray-300 dark:to-transparent",
